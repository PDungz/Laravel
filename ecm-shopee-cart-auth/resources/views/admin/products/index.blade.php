...
@section('content')
    <div class="margin-bottom">
        ...
        <div class="right">
            <a class="btn btn-primary" href="{{route('admin.products.create')}}">Thêm</a>
        </div>
                ...
                @foreach ($products as $product)
                    <tr>
                        ...
                        <td style="text-align: center">
                            <a class="btn btn-primary" href="{{route('admin.products.show', $product->id)}}">Xem</a>
                            <a id="btnEdit" class="btn btn-warning" href="{{route('admin.products.edit', $product->id)}}">Sửa</a>
