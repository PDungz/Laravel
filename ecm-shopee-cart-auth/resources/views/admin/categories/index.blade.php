...
@section('content')
    <div>
        ...
        <div class="right">
            <a class="btn btn-primary margin-top" href="{{route('admin.categories.create')}}" > Thêm danh mục</a>
        </div>
                ...
                @foreach ($categories as $category)
                    <tr>
                        ...
                        <td style="text-align: center">
                            ...
                            <form action="{{route('admin.categories.destroy', $category->id)}}" method="post" onsubmit="return confirmDelete();">
                                @csrf
                                @method('DELETE')
