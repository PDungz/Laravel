...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return redirect()->route('admin.products.index')->with('error', 'Không thể tìm kiếm. Vui lòng thử lại sau');
        }
    }
    ...
    public function edit(Product $product)
    {
        try {
            ...
            return redirect()->route('admin.products.index')->with('error', 'Không thể hiển thị form chỉnh sửa sản phẩm. Vui lòng thử lại.');
        }
    }
    ...
    public function destroy(Product $product)
    {
        ...
        return redirect()->route('admin.products.index')->with('error', 'Không thể xóa sản phẩm. Vui lòng thử lại.');
    }
    }
}
